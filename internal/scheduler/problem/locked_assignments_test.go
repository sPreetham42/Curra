...
func TestLockedAssignments_LockedVsLockedFacultyConflict(t *testing.T) {
	...
	if !testutil.HasViolationMessageContaining(violations, "locked assignment faculty conflict") {
...
func TestLockedAssignments_LockedVsLockedRoomConflict(t *testing.T) {
	...
	violations := problem.Validate(p)
	if !testutil.HasViolationMessageContaining(violations, "locked assignment room conflict") {
...
func TestLockedAssignments_LockedVsLockedStudentGroupOverlapConflict(t *testing.T) {
	...
	violations := problem.Validate(p)
	if !testutil.HasViolationMessageContaining(violations, "locked assignment student group overlap conflict") {
...
func TestLockedAssignments_LockedCapacityViolation(t *testing.T) {
	...
	violations := problem.Validate(p)
	if !testutil.HasViolationMessageContaining(violations, "locked assignment room capacity is below student group size") {
...
func TestLockedAssignments_LockedRoomFeatureViolation(t *testing.T) {
	...
	violations := problem.Validate(p)
	if !testutil.HasViolationMessageContaining(violations, "locked assignment room does not provide all required features") {
...
func TestLockedAssignments_LockedAvailabilityViolation(t *testing.T) {
	...
	violations := problem.Validate(p)
	if !testutil.HasViolationMessageContaining(violations, "locked assignment faculty is not available") {
...
func TestLockedAssignments_LockedSessionsExceedingRequirementCount(t *testing.T) {
	...
	violations := problem.Validate(p)
	if !testutil.HasViolationMessageContaining(violations, "locked sessions exceed session requirement count") {
