...
func TestMoveValidator_FacultyConflict(t *testing.T) {
	...
	if !testutil.HasViolation(result.Violations, "FacultyConflict") {
...
func TestMoveValidator_RoomConflict(t *testing.T) {
	...
	if !testutil.HasViolation(result.Violations, "RoomConflict") {
...
func TestMoveValidator_GroupConflict(t *testing.T) {
	...
	if !testutil.HasViolation(result.Violations, "StudentGroupConflict") {
...
func TestMoveValidator_CapacityViolation(t *testing.T) {
	...
	if !testutil.HasViolation(result.Violations, "RoomCapacity") {
...
func TestMoveValidator_RoomFeatureViolation(t *testing.T) {
	...
	if !testutil.HasViolation(result.Violations, "RoomFeatureCompatibility") {
...
func TestMoveValidator_FacultyAvailabilityViolation(t *testing.T) {
	...
	if !testutil.HasViolation(result.Violations, "FacultyAvailability") {
...
func TestMoveValidator_RoomAvailabilityViolation(t *testing.T) {
	...
	if !testutil.HasViolation(result.Violations, "RoomAvailability") {
